...
companies = Text.output_first(sql_queries()[0])
projects = Text.output_second(sql_queries()[1])
Text.sizing(companies)
Text.sizing(projects)
...
print_text(companies, "companies")
# print_text(projects, "projects")
